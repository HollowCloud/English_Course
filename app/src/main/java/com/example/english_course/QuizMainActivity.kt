    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_start.setOnClickListener {
            ...
            if (et_name.text.toString().isEmpty()) {
                ...
                Toast.makeText(this@QuizMainActivity, "Please enter your name", Toast.LENGTH_SHORT)
                    .show()
            } else {

                val intent = Intent(this@QuizMainActivity, QuizQuestionsActivity::class.java)
